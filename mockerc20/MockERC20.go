...
//
// Solidity: function mint(address usr_, uint256 amount_) returns()
func (_Mockerc20 *Mockerc20Transactor) Mint(opts *bind.TransactOpts, usr_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _Mockerc20.contract.Transact(opts, "mint", usr_, amount_)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address usr_, uint256 amount_) returns()
func (_Mockerc20 *Mockerc20Session) Mint(usr_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _Mockerc20.Contract.Mint(&_Mockerc20.TransactOpts, usr_, amount_)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address usr_, uint256 amount_) returns()
func (_Mockerc20 *Mockerc20TransactorSession) Mint(usr_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _Mockerc20.Contract.Mint(&_Mockerc20.TransactOpts, usr_, amount_)
}
