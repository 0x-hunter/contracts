...
func (_Contract *ContractTransactor) Mint(opts *bind.TransactOpts, usr_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "mint", usr_, amount_)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address usr_, uint256 amount_) returns()
func (_Contract *ContractSession) Mint(usr_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.Mint(&_Contract.TransactOpts, usr_, amount_)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address usr_, uint256 amount_) returns()
func (_Contract *ContractTransactorSession) Mint(usr_ common.Address, amount_ *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.Mint(&_Contract.TransactOpts, usr_, amount_)
}
