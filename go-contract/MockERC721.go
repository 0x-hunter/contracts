...
func (_Contract *ContractTransactor) Mint(opts *bind.TransactOpts, _usr common.Address, _tokenId *big.Int) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "mint", _usr, _tokenId)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address _usr, uint256 _tokenId) returns()
func (_Contract *ContractSession) Mint(_usr common.Address, _tokenId *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.Mint(&_Contract.TransactOpts, _usr, _tokenId)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address _usr, uint256 _tokenId) returns()
func (_Contract *ContractTransactorSession) Mint(_usr common.Address, _tokenId *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.Mint(&_Contract.TransactOpts, _usr, _tokenId)
}
