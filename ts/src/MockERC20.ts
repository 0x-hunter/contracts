...
export type ContractContext = Web3ContractContext<
  MockERC20,
  MockERC20MethodNames,
  MockERC20EventsContext,
  MockERC20Events
>;
export type MockERC20Events = 'Approval' | 'Transfer';
export interface MockERC20EventsContext {
  Approval(
    parameters: {
...
export type MockERC20MethodNames =
  | 'new'
  | 'allowance'
  | 'approve'
  | 'balanceOf'
...
export interface MockERC20 {
   ...
   * @param decimals_ Type: uint8, Indexed: false
   */
  'new'(
    name_: string,
    symbol_: string,
    decimals_: string | number
  ): MethodReturnContext;
  /**
   * Payable: false
   * Constant: true
   ...
   * StateMutability: nonpayable
   * Type: function
   * @param usr_ Type: address, Indexed: false
   * @param amount_ Type: uint256, Indexed: false
   */
  mint(usr_: string, amount_: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
