...
export type ContractContext = Web3ContractContext<
  MockERC1155,
  MockERC1155MethodNames,
  MockERC1155EventsContext,
  MockERC1155Events
>;
export type MockERC1155Events =
  | 'ApprovalForAll'
  | 'TransferBatch'
  | 'TransferSingle'
  | 'URI';
export interface MockERC1155EventsContext {
  ApprovalForAll(
    parameters: {
...
export type MockERC1155MethodNames =
  | 'new'
  | 'balanceOf'
  | 'balanceOfBatch'
  | 'isApprovedForAll'
...
export interface MockERC1155 {
   ...
   */
  mint(tokenId: string, amount: string, to: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
