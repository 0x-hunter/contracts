...
export type ContractContext = Web3ContractContext<
  ...
  HunterGovernanceTokenMethodNames,
  HunterGovernanceTokenEventsContext,
  HunterGovernanceTokenEvents
>;
export type HunterGovernanceTokenEvents =
  | 'Approval'
  | 'OwnershipTransferred'
  | 'Transfer';
export interface HunterGovernanceTokenEventsContext {
  Approval(
    parameters: {
...
export type HunterGovernanceTokenMethodNames =
  | 'new'
  | 'OPERATOR_ROLE'
  | 'SUPPLY_CAP'
  | 'allowance'
...
export interface HunterGovernanceToken {
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
   * Type: constructor
   * @param _premintReceiver Type: address, Indexed: false
   * @param _premintAmount Type: uint256, Indexed: false
   */
  'new'(_premintReceiver: string, _premintAmount: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: true
   ...
   * Type: function
   */
  OPERATOR_ROLE(): MethodConstantReturnContext<string>;
  /**
   * Payable: false
   * Constant: true
   ...
   * Type: function
   */
  SUPPLY_CAP(): MethodConstantReturnContext<string>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   ...
   * @param amount Type: uint256, Indexed: false
   */
  mint(account: string, amount: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
