...
export type ContractContext = Web3ContractContext<
  IUniswapV3Pool,
  IUniswapV3PoolMethodNames,
  IUniswapV3PoolEventsContext,
  IUniswapV3PoolEvents
>;
export type IUniswapV3PoolEvents =
  | 'Burn'
  | 'Collect'
  | 'CollectProtocol'
  | 'Flash'
  ...
  | 'SetFeeProtocol'
  | 'Swap';
export interface IUniswapV3PoolEventsContext {
  Burn(
    parameters: {
      filter?: {
        owner?: string | string[];
...
export type IUniswapV3PoolMethodNames =
  | 'burn'
  | 'collect'
  | 'collectProtocol'
  | 'factory'
...
export interface IUniswapV3Pool {
   ...
   */
  increaseObservationCardinalityNext(
    observationCardinalityNext: string | number
  ): MethodReturnContext;
  /**
   * Payable: false
   * Constant: false
   ...
   */
  observe(
    secondsAgos: string | number[]
  ): MethodConstantReturnContext<ObserveResponse>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   ...
   */
  setFeeProtocol(
    feeProtocol0: string | number,
    feeProtocol1: string | number
  ): MethodReturnContext;
  /**
   * Payable: false
   * Constant: true
